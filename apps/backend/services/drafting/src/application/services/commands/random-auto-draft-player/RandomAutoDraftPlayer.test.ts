import { PickRepository, DraftRepository, DraftUserRepository, RandomIndexGenerator } from "../../../../interfaces";
import {
    Draft,
    DraftOrderEnum,
...
import { RandomAutoDraftPlayer } from "./RandomAutoDraftPlayer";
...
describe("RandomAutoDraftPlayer", () => {
    ...
    beforeEach(() => {
        ...
        autoDraftPlayer = new RandomAutoDraftPlayer(
            pickPlayer,
            pickRepository,
            draftRepository,
            draftUserRepository,
