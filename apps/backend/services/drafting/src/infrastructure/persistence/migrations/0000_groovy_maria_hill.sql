CREATE TABLE IF NOT EXISTS "draft_picks" (
	...
	CONSTRAINT "draft_player" UNIQUE("draft_id","player_id")
);
...
CREATE TABLE IF NOT EXISTS "drafts" (
	...
	"draft_order_type" varchar NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "draft_player_queues" ADD CONSTRAINT "draft_player_queues_draft_id_drafts_id_fk" FOREIGN KEY ("draft_id") REFERENCES "public"."drafts"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "draft_player_queues" ADD CONSTRAINT "draft_player_queues_player_id_players_id_fk" FOREIGN KEY ("player_id") REFERENCES "public"."players"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
